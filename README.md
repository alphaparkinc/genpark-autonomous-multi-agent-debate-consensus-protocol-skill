# genpark-autonomous-multi-agent-debate-consensus-protocol-skill
...
> **GenPark AI Agent Skill** -- Autonomous multi-agent debate consensus protocol & planning (AutoGPT / CAMEL)
